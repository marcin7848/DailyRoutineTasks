...
import com.dailyroutinetasks.database.dao.HabitDao;
...
@Database(entities = {Day.class, Task.class, Setting.class, DefaultTask.class, Habit.class}, version = 1, exportSchema = false)
